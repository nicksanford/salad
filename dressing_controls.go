...
type dressingControls struct {
	...
	assetsMu       sync.Mutex
	worldObstacles *referenceframe.GeometriesInFrame
...
func (s *dressingControls) loadWorldState() error {
	...
	s.worldObstacles = referenceframe.NewGeometriesInFrame(referenceframe.World, []spatialmath.Geometry{octree})
	return nil
}
...
func (s *dressingControls) reset(ctx context.Context) (map[string]interface{}, error) {
	...
	req := &armplanning.PlanRequest{
		FrameSystem:           fs,
		ObstaclesInWorldFrame: s.worldObstacles,
